...
def _system_prompt(attribute: Attribute, indication: str, intervention_class: str) -> str:
    return (
        ...
        "THIS variable (same unit as the target). Use ONE value per distinct source; do "
        "not repeat the same source. Skip insights with no comparable number. Classify "
        "each source into one source_type from this list:\n"
