...
def build_review_system_prompt() -> str:
    ...
    return (
        ...
        "contract under the shared comparison policy. If the supplied contract violates that "
        "policy, flag the affected candidate and identify the rule rather than silently repairing "
        "it or rejecting evidence merely for a different measured value. The target cutoff, comparator, role, and "
